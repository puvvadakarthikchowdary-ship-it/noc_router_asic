...
export SAVE_NETLIST='./results/synthesis/noc_top.v';
...
export VERILOG_FILES='openlane/designs/noc_router/src/noc_top.v openlane/designs/noc_router/src/fifo.v openlane/designs/noc_router/src/router.v openlane/designs/noc_router/src/tb_noc.v openlane/designs/noc_router/src/arbiter.v';
