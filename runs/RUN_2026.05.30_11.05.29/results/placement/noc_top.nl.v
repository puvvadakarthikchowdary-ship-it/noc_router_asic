module noc_top (clk,
 ...
 sky130_fd_sc_hd__clkbuf_1 _29_ (.A(_18_),
    .X(_01_));
 sky130_fd_sc_hd__xnor2_1 _30_ (.A(net4),
    .B(_16_),
    .Y(_02_));
 sky130_fd_sc_hd__and4_1 _31_ (.A(net2),
    .B(net3),
    .C(net4),
    .D(net5),
    .X(_19_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _34_ (.A(_21_),
    .X(_03_));
 sky130_fd_sc_hd__xor2_1 _35_ (.A(net6),
    .B(_19_),
    .X(_04_));
 sky130_fd_sc_hd__and3_1 _36_ (.A(net6),
    ...
    .C(_19_),
    .X(_22_));
 sky130_fd_sc_hd__a21oi_1 _37_ (.A1(net6),
    .A2(_19_),
    .B1(net7),
    .Y(_23_));
 sky130_fd_sc_hd__nor2_1 _38_ (.A(_22_),
    .B(_23_),
    .Y(_05_));
 sky130_fd_sc_hd__xor2_1 _39_ (.A(net8),
    .B(_22_),
    .X(_06_));
 sky130_fd_sc_hd__and4_1 _40_ (.A(net6),
    ...
    .D(_19_),
    .X(_24_));
 sky130_fd_sc_hd__xor2_1 _41_ (.A(net9),
    .B(_24_),
    .X(_07_));
